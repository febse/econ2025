...
Compute the probability of the events $X > 2 \sigma$ and $x < 2\sigma$ for two normal distributions:
- One with mean $\mu = 0$ and standard deviation $\sigma = 1$ (the standard normal)
- Another with mean $\mu = 0$ and standard deviation $\sigma = 3$
