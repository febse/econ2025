...
which is just a compact way of writing the two equations that ensure that the residuals are orthogonal to the plane spanned by the predictors.
...
Note that on the diagonals we have the sum of the squares of the predictors and on the off-diagonals we have the sum of the products of the predictors. In order to avoid the long sums, we can instead replace them with the shorthand notation 
of the averages:
