...
Write a function called `ols_no_intercept` that calculates the OLS estimate for $\hat{\beta}_1$ in the no-intercept
equation
...
As in the previous exercise, it is convinient to replace the variable names with generic ones:
...
# Now call your function with some vectors
```
