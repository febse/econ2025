...
Create a two new columns in the `earnings` dataset:

-   The first one should be called `earn_eur` and should contain the annual income in EUR (take 1 EUR = 1.05 USD as the exchange rate).
-   The second one should be called `earnk_eur` and should contain the annual income in 1,000 EUR.
:::
